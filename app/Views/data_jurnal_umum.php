                    ...
                    <div class="row pb-3 pt-2">
                        <div class="col-3">
                            <form action="/jurnal_umum" method="get">
                                <input required name="keyword" type="text" class="form-control" placeholder="Cari Transaksi">
                            </form>
                        </div>
                            ...
                            <tbody>
                                <?php foreach ($data_jurnal_umum as $key => $x) : ?>
                                    <tr>
                                        ...
                                        <td><?= tanggal_in_bahasa($x["tgl_transaksi"])  ?> </td>
                                        <td><?= $x["no_akun"] ?></td>
                                                        ...
                                                        <form action="/jurnal_umum/edit/<?= $x["no_transaksi"] ?>" method="POST">
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input required required type="date" name="tgl_transaksi" class="form-control" id="tgl_transaksi" value="<?= $x["tgl_transaksi"] ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="keterangan">Keterangan</label>
                                                                    <input required type="text" name="keterangan_transaksi" class="form-control" id="keterangan" value="<?= $x["keterangan_transaksi"] ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="no_akun">No Akun</label>
                                                                    <select required name="no_akun" id="no_akun" class="form-control">
                                            ...
                                            <div class="modal fade" id="hapusJurnalUmum<?= $key ?>" tabindex="-1" aria-labelledby="hapusJurnalUmumLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/jurnal_umum/del/<?= $x["no_transaksi"] ?>" class="btn btn-danger">Hapus</a>
